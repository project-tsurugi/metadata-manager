...
INSTANTIATE_TEST_CASE_P(ParameterizedTest, ApiTestTablePrivilegesSingle,
                        ::testing::Values(test_pattern_list_single));

INSTANTIATE_TEST_CASE_P(ParameterizedTest, ApiTestTablePrivilegesMultiple,
                        ::testing::Values(test_pattern_list_multiple));

INSTANTIATE_TEST_CASE_P(ParameterizedTest, ApiTestTablePrivilegesInvalid,
