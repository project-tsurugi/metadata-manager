...
class ConstraintsDAO : public GenericDAO {
 public:
  ...
  virtual manager::metadata::ErrorCode insert_constraint_metadata(
      const boost::property_tree::ptree& constraint_metadata, ObjectId& constraint_id) const = 0;

  virtual manager::metadata::ErrorCode select_constraint_metadata(
      std::string_view object_key, std::string_view object_value,
      boost::property_tree::ptree& constraint_metadata) const = 0;
  virtual manager::metadata::ErrorCode select_constraint_metadata(
