...
class Iterator {
 public:
  ...
  virtual ErrorCode next(manager::metadata::Object& obj) = 0;
};
...
class Metadata {
 public:
  ...
  void get(const size_t index, manager::metadata::Object& obj) const {
...
class MetadataIterator : public Iterator {
 public:
  explicit MetadataIterator(const manager::metadata::Metadata* metadata)
      : metadata_(metadata), cursor_(0) {}

  bool has_next() const override;
  ErrorCode next(manager::metadata::Object& obj) override;

 private:
  const manager::metadata::Metadata* metadata_;
  size_t cursor_;
};
