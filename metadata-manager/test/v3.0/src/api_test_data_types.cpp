...
void check_datatype_metadata_expected(const ptree& datatype) {
    ...
    switch (data_type_id) {
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::INT32): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::INT32,
        ...
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::INT64): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::INT64,
                      pg_data_type_qualified_name);
        } break;
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::FLOAT32): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::FLOAT32,
                      pg_data_type_qualified_name);
        } break;
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::FLOAT64): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::FLOAT64,
                      pg_data_type_qualified_name);
        } break;
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::CHAR): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::CHAR,
                      pg_data_type_qualified_name);
        } break;
        case static_cast<ObjectIdType>(DataTypes::DataTypesId::VARCHAR): {
            ...
            EXPECT_EQ(PgDataTypeQualifiedName::VARCHAR,
                      pg_data_type_qualified_name);
        } break;
        default: {
