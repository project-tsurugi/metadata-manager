 ...
 */
void UTUtils::print_table_statistics(
  ...
  print("id:", (metadata_id ? metadata_id.get() : 0));
  print("name:", (metadata_name ? metadata_name.get() : "NULL"));
  print("namespace:", (metadata_namespace ? metadata_namespace.get() : "NULL"));
  print("reltuples:", (metadata_tuples ? metadata_tuples.get() : 0));
}
