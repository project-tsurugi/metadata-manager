...
- [統合メタデータ管理基盤 統計情報管理機能 改造仕様書](#%E7%B5%B1%E5%90%88%E3%83%A1%E3%82%BF%E3%83%87%E3%83%BC%E3%82%BF%E7%AE%A1%E7%90%86%E5%9F%BA%E7%9B%A4-%E7%B5%B1%E8%A8%88%E6%83%85%E5%A0%B1%E7%AE%A1%E7%90%86%E6%A9%9F%E8%83%BD-%E6%94%B9%E9%80%A0%E4%BB%95%E6%A7%98%E6%9B%B8)
  ...
  - [外部設計](#%E5%A4%96%E9%83%A8%E8%A8%AD%E8%A8%88)
    ...
    - [Tablesクラスメソッド ※変更分のみ](#tables%E3%82%AF%E3%83%A9%E3%82%B9%E3%83%A1%E3%82%BD%E3%83%83%E3%83%89-%E2%80%BB%E5%A4%89%E6%9B%B4%E5%88%86%E3%81%AE%E3%81%BF)
      - [get_allstd::vector\<boost::property_tree::ptree>& objects](#get_allstdvector%5Cboostproperty_treeptree-objects)
      - [get_statisticconst ObjectIdType object_id, boost::property_tree::ptree& ptree](#get_statisticconst-objectidtype-object_id-boostproperty_treeptree-ptree)
      - [get_statisticstd::string_view object_name, boost::property_tree::ptree& ptree](#get_statisticstdstring_view-object_name-boostproperty_treeptree-ptree)
      - [set_statisticboost::property_tree::ptree& ptree](#set_statisticboostproperty_treeptree-ptree)
    - [Statisticsメソッド](#statistics%E3%83%A1%E3%82%BD%E3%83%83%E3%83%89)
      - [getconst ObjectIdType object_id, boost::property_tree::ptree& ptree](#getconst-objectidtype-object_id-boostproperty_treeptree-ptree)
      - [getstd::string_view object_name, boost::property_tree::ptree ptree](#getstdstring_view-object_name-boostproperty_treeptree-ptree)
      - [get_allstd::vecotr\<boost::property_tree::ptree>& objects;](#get_allstdvecotr%5Cboostproperty_treeptree-objects)
      - [get_by_column_idconst ObjectIdType table_id, const ObjectIdType column_id, boost::property_tree::ptree ptree](#get_by_column_idconst-objectidtype-table_id-const-objectidtype-column_id-boostproperty_treeptree-ptree)
      - [get_by_column_nameObjectIdType table_id, std::string_view column_name, boost::property_tree::ptree ptree](#get_by_column_nameobjectidtype-table_id-stdstring_view-column_name-boostproperty_treeptree-ptree)
      - [get_by_column_numberObjectIdType table_id, uint64_t column_number, boost::property_tree::ptree ptree](#get_by_column_numberobjectidtype-table_id-uint64_t-column_number-boostproperty_treeptree-ptree)
      - [get_all_by_table_idObjectIdType table_id, std::vecotr\<boost::property_tree::ptree> objects](#get_all_by_table_idobjectidtype-table_id-stdvecotr%5Cboostproperty_treeptree-objects)
...
- 変更後のgetメソッド
  ...
  - Tablesクラス
    - get(id, ptree); // 標準メソッド
    - get(name, ptree); // 標準メソッド
    - get_all(objects); // 標準メソッド。すべてのテーブルオブジェクトを取得する
    - get_statistic(id, ptree); // 表統計情報用メソッド
    - get_statistic(name, ptree); // 表統計情報用メソッド
  
  - Statisticsクラス
    - get(id, ptree); // 標準メソッド
    - get(name, ptree); // 標準メソッド
    - get_all(objects);  // 標準メソッド。すべての列統計情報を取得する
    - get_by_column_id(table_id, column_id, ptree); // カラムIDを指定して列統計情報を取得する
    - get_by_column_name(table_id, column_name, ptree); // カラム名を指定して列統計情報を取得する
    - get_by_column_number(table_id, column_number, ptree); // カラム番号を指定して列統計情報を取得する
    - get_all_by_table_id(table_id, objects);  // 特定のテーブルに属するすべての列統計情報を取得する
...
- 概要
  ...
  指定されたオブジェクトIDを持つ表統計情報オブジェクトを返す。
...
- 概要
  ...
  統合メタデータ管理基盤上のすべての統計情報オブジェクトを返す。
...
#### get_by_column_id(const ObjectIdType table_id, const ObjectIdType column_id, boost::property_tree::ptree ptree)

- 概要

  指定されたテーブルID、カラムIDを持つ統計情報オブジェクトを返す。
...
#### get_by_column_name(ObjectIdType table_id, std::string_view column_name, boost::property_tree::ptree ptree)
...
#### get_by_column_number(ObjectIdType table_id, uint64_t column_number, boost::property_tree::ptree ptree)
...
#### get_all_by_table_id(ObjectIdType table_id, std::vecotr\<boost::property_tree::ptree> objects)

- 概要

  指定されたテーブルIDを持つ統計情報オブジェクトのコンテナを返す。
