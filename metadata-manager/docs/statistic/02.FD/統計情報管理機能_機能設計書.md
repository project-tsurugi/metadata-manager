...
| プロパティ名（論理名） | 型        | 値の範囲                                                     |
| ---------------------- | --------- | ------------------------------------------------------------ |
| エラーコード           | ErrorCode | ErrorCode::OK：正常<br />ErrorCode::OPEN_CONNECTION_FAILURE：コネクションの確立に失敗<br/>ErrorCode::PREPARE_STATEMENT_FAILURE：SQL文の前処理に失敗<br/>SET_ALWAYS_SECURE_SEARCH_PATH_FAILURE：セキュアなサーチパスの設定に失敗 |
...
| プロパティ名（論理名） | 型        | 値の範囲                                                     |
| ---------------------- | --------- | ------------------------------------------------------------ |
| エラーコード           | ErrorCode | ErrorCode::OK：正常<br />ErrorCode::UPSERT_FAILURE：UPSERTのSQL文の発行に失敗<br/>ErrorCode::BEGIN_TRANSACTION_FAILURE：トランザクションの開始に失敗<br/>ErrorCode::COMMIT_FAILURE：コミット失敗<br/>ErrorCode::ROLLBACK_FAILURE：ロールバック失敗 |
...
| プロパティ名（論理名） | 型        | 値の範囲                                                     |
| ---------------------- | --------- | ------------------------------------------------------------ |
| エラーコード           | ErrorCode | ErrorCode::OK：正常<br />ErrorCode::UPDATE_FAILURE：UPDATEのSQL文の発行に失敗<br/>ErrorCode::BEGIN_TRANSACTION_FAILURE：トランザクションの開始に失敗<br/>ErrorCode::COMMIT_FAILURE：コミット失敗<br/>ErrorCode::ROLLBACK_FAILURE：ロールバック失敗|
...
| プロパティ名（論理名） | 型        | 値の範囲                                           |
| ---------------------- | --------- | -------------------------------------------------- |
| エラーコード           | ErrorCode | ErrorCode::OK：正常<br />ErrorCode::SELECT_FAILURE：SELECTのSQL文の発行に失敗 |
...
| プロパティ名（論理名） | 型        | 値の範囲                                                     |
| ---------------------- | --------- | ------------------------------------------------------------ |
| エラーコード           | ErrorCode | ErrorCode::OK：正常<br />ErrorCode::DELETE_FAILURE：DELETEのSQL文の発行に失敗<br/>ErrorCode::BEGIN_TRANSACTION_FAILURE：トランザクションの開始に失敗<br/>ErrorCode::COMMIT_FAILURE：コミット失敗<br/>ErrorCode::ROLLBACK_FAILURE：ロールバック失敗|
