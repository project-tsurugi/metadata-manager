...
* OSの環境変数から、Connection Stringsを取得する。
...
### 初期化処理
![](./out/uml/SequenceDiagram_detail/初期化処理.png)

### 終了処理
* PGConnをstd::shared_ptr<PGconn>で定義して、std::shared_ptr<PGconn>のdeleterで、PQfinishを呼ぶ。
