 ...
 */
#ifndef MANAGER_METADATA_MANAGER_INCLUDE_MANAGER_METADATA_COMMON_JWT_CLAIMS_H_
#define MANAGER_METADATA_MANAGER_INCLUDE_MANAGER_METADATA_COMMON_JWT_CLAIMS_H_
...
#endif  // MANAGER_METADATA_MANAGER_INCLUDE_MANAGER_METADATA_COMMON_JWT_CLAIMS_H_
